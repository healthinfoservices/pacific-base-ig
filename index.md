# Home - Pacific Base FHIR Implementation Guide v1.0.0
...
Distributed under the [MIT License](https://healthinfoservices.net/pacific-base-ig/LICENSE.html).
...
```json
{
  ...
  "id" : "pacific.base.ig",
  "url" : "https://healthinfoservices.net/pacific-base-ig/ImplementationGuide/pacific.base.ig",
  "version" : "1.0.0",
  "name" : "PacificBaseIG",
  "title" : "Pacific Base FHIR Implementation Guide",
  "status" : "draft",
  "date" : "2026-03-12T07:48:11+00:00",
  "description" : "FHIR Implementation Guide with Base Definitions for nations in the Pacific",
  "packageId" : "pacific.base.ig",
  "license" : "MIT",
  "fhirVersion" : ["4.3.0"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://healthinfoservices.net/pacific-base-ig/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-vital-blood-pressure"
      },
      "name" : "Blood Pressure Observation (Pacific region)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-vital-bmi"
      },
      "name" : "BMI Vitals (Pacific region)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-vital-body-temperature"
      },
      "name" : "Body Temperature Vitals (Pacific region)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Patient/PacificPatientFijiITaukei"
      },
      ...
      "exampleCanonical" : "https://healthinfoservices.net/pacific-base-ig/StructureDefinition/pacific-patient"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "Patient/PacificPatientFijiIndo"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-vital-heart-rate"
      },
      "name" : "Heart Rate Vitals (Pacific region)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-vital-height"
      },
      "name" : "Height Vitals (Pacific region)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-address-island"
      },
      "name" : "Island",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-vital-oxygen-saturation"
      },
      "name" : "Oxygen Saturation Vitals (Pacific region)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-address"
      },
      "name" : "Pacific Address",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-allergy-intolerance"
      },
      "name" : "Pacific Allergy/Intolerance",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-clan-affiliation"
      },
      "name" : "Pacific Clan Affiliation",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-condition"
      },
      "name" : "Pacific Condition",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-organization"
      },
      "name" : "Pacific Healthcare Organization",
    ...
    },
    {
      ...
      "name" : "Pacific Hospital Example – Fiji Divisional Hospital",
      "description" : "Example Pacific hospital organization in Fiji.\nIncludes organizational identifier, contact information, and address.",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-humanname"
      },
      "name" : "Pacific HumanName",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-observation"
      },
      "name" : "Pacific Observation",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-patient"
      },
      "name" : "Pacific Patient",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-practitioner"
      },
      "name" : "Pacific Practitioner",
    ...
    },
    {
      ...
      "name" : "Pacific Practitioner Example – Samoa",
      "description" : "Registered practitioner with official registration name and usual community name including clan affiliation.",
      "exampleCanonical" : "https://healthinfoservices.net/pacific-base-ig/StructureDefinition/pacific-practitioner"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-practitioner-role"
      },
      "name" : "Pacific Practitioner Role",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "PractitionerRole/PacificPractitionerRoleExample"
      },
      "name" : "Pacific Practitioner Role District Hospital GP",
      "description" : "General Practitioner role at district hospital for registered Pacific practitioner.",
      "exampleCanonical" : "https://healthinfoservices.net/pacific-base-ig/StructureDefinition/pacific-practitioner-role"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "Patient/PacificPatientExample1"
      },
      "name" : "PacificPatientExample1",
      "exampleCanonical" : "https://healthinfoservices.net/pacific-base-ig/StructureDefinition/pacific-patient"
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "Patient/PacificPatientExample2"
      },
      "name" : "PacificPatientExample2",
      "exampleCanonical" : "https://healthinfoservices.net/pacific-base-ig/StructureDefinition/pacific-patient"
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-vital-respiratory-rate"
      },
      "name" : "Respiratory Rate Vitals (Pacific region)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-address-village"
      },
      "name" : "Village",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/pacific-vital-weight"
      },
      "name" : "Weight Vitals (Pacific region)",
