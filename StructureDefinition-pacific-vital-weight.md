# Weight Vitals (Pacific region) - Pacific Base FHIR Implementation Guide v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Weight Vitals (Pacific region)**

## Resource Profile: Weight Vitals (Pacific region) 

| | |
| :--- | :--- |
| *Official URL*:https://healthinfoservices.net/pacific-base-ig/StructureDefinition/pacific-vital-weight | *Version*:1.0.0 |
| Draft as of 2026-03-12 | *Computable Name*:PacificWeight |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/pacific.base.ig|current/StructureDefinition/pacific-vital-weight)
...
```json
{
  ...
  "url" : "https://healthinfoservices.net/pacific-base-ig/StructureDefinition/pacific-vital-weight",
  "version" : "1.0.0",
  "name" : "PacificWeight",
